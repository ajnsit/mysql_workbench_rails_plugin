-- Lua Utility Library for MySQL Workbench 5.0
...
--
-- 2009-05-08 Added some helper methods to deal with rails schemas
-- Author: Anupam Jain <ajnsit@gmail.com>
...
function find_all_tables_matching(table_name_regex)
  local schema_count= count_schemata()
  local schema_i
  local table_count
  local table_i
  local tables
